...
/* ---- the evidence stage's glyphs: player, drawing tools, capture ---- */

/** Pause, for a player: two filled bars. */
...
/** A picture (attach, paste a screenshot). */
...
/** The arrow drawing tool (a diagonal arrow, distinct from `IconArrowRight`). */
...
/** Select an area of the screen: four corner marks. */
